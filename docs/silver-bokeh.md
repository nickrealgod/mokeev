...
Asset: `dist/assets/silver-bokeh.webp` (1536 × 1024). The site applies a separate 93% white overlay and caches the composite at the viewport size. The environment is an artistic interpretation of the silver letters' reflections, not a reconstruction of the original lighting map.
...
- Static photo and its white overlay composed only after loading or resizing.
